...
class DMCollector(Monitor):
    ...
    def enable_log(self, type_name, start_timestamp = None, end_timestamp = None):
        ...
        # print("offline replayer start_timestamp: ", start_timestamp)
        # print("offline replayer end_timestamp: ", end_timestamp)
        # offline replayer start_timestamp:  1605548940.0 seconds
        # offline replayer end_timestamp:  1605549000.0 seconds
